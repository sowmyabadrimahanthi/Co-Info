      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <div class="mb-0 site-logo"><a href="index.html" class="mb-0">Co-<span class="text-primary">Info</span> </a></div>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="prevention.html" class="nav-link">Prevention</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mr-auto text-center text-lg-left">
            ...
            <p class="mb-5">The great outdoors will still be "great" when the pandenic ends. stay home & flatten the curve</p>
            <p class="mb-4"><a href="status.html" class="btn btn-primary">LIVE STATUS</a></p>
